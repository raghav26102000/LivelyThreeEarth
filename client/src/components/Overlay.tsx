    ...
    <div className="w-full min-h-full font-sans text-brand-dark bg-gradient-to-b from-white via-brand-light/20 to-white overflow-x-hidden">
      ...
      <Section>
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-brand-dark/70 leading-relaxed max-w-xl">
            ...
            <br />
            <span className="text-brand-leaf font-medium">Naturally! From gut to body to mind.</span>
          </p>
      ...
      <Section className="items-center">
        ...
        >
          ...
          <p className="text-xl text-brand-dark/70 max-w-2xl mx-auto">
            These aren't just nutrients—they're the foundation of every healthy cell, every energized moment, every vibrant day.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
          ...
          >
            ...
            <h3 className="font-display text-3xl text-brand-deep mb-3">Fiber</h3>
            <p className="text-brand-dark/70 leading-relaxed mb-4">
              Essential for gut health and longevity. Your microbiome thrives on fiber, supporting everything from digestion to immunity to mental clarity.
            </p>
          ...
          >
            ...
            <h3 className="font-display text-3xl text-brand-deep mb-3">Protein</h3>
            <p className="text-brand-dark/70 leading-relaxed mb-4">
              Building blocks for repair and strength. Every cell in your body depends on protein for structure, function, and renewal.
            </p>
            <div className="text-sm text-brand-leaf font-medium">
          ...
          >
            ...
            <h3 className="font-display text-3xl text-brand-deep mb-3">Micronutrients</h3>
            <p className="text-brand-dark/70 leading-relaxed mb-4">
              The unseen power of cellular function. Vitamins and minerals orchestrate thousands of biochemical reactions that keep you thriving.
            </p>
            <div className="text-sm text-brand-leaf font-medium">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-brand-dark/80 leading-relaxed mb-6">
              This isn't just an app—it's a movement. We're building a community-centric, data-driven platform where <strong>you own your data</strong> and contribute to collective wellness insights.
            </p>
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-brand-deep mb-1">Data Ownership</h4>
                  <p className="text-brand-dark/70">Your health data belongs to you. Grant or revoke access on your terms.</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 bg-brand-leaf/20 rounded-full flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  <h4 className="font-semibold text-brand-deep mb-1">Community-Driven</h4>
                  <p className="text-brand-dark/70">Join thousands making mindful choices together, sharing insights, not selling data.</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 bg-brand-leaf/20 rounded-full flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  <h4 className="font-semibold text-brand-deep mb-1">Sustainability First</h4>
                  <p className="text-brand-dark/70">Track your environmental impact. Better nutrition for you and the planet.</p>
                </div>
              </div>
            </div>
          </motion.div>
            ...
            <div className="space-y-4">
              {[
                ...
                >
                  ...
                  <span className="text-brand-dark font-medium">{item.text}</span>
                </motion.div>
              ))}
            </div>
          </motion.div>
      ...
      <Section>
        ...
        >
          ...
          <p className="text-xl text-brand-dark/70 max-w-2xl mx-auto">
            See your daily progress at a glance. Understand how your choices ripple through your health and the environment.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            >
              ...
              <h4 className="font-display text-xl text-brand-deep mb-2">{feature.title}</h4>
      ...
      <Section className="items-center justify-center text-center bg-gradient-to-br from-white via-brand-light/20 to-white">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 text-left">
            <div>
              <div className="text-5xl md:text-6xl font-bold text-brand-leaf mb-3">1 in 10</div>
              <p className="text-brand-dark/80 leading-relaxed">
                People hit their daily fiber target. We're here to change that.
              </p>
            </div>
            <div>
              <div className="text-5xl md:text-6xl font-bold text-brand-leaf mb-3">45%</div>
              <p className="text-brand-dark/80 leading-relaxed">
                Increase in energy levels reported by users who track consistently.
              </p>
            </div>
            <div>
              <div className="text-5xl md:text-6xl font-bold text-brand-leaf mb-3">100%</div>
              <p className="text-brand-dark/80 leading-relaxed">
      ...
      <Section className="py-20">
        ...
        >
          ...
          <p className="text-xl text-brand-dark/70 max-w-2xl mx-auto">
            From foundation to global movement—here's how we're building the future of nutrition.
          </p>
        </motion.div>
            ...
            {[
              {
                ...
                items: ["Initial design", "Establish ethical guidelines", "Implement core tracking, data ownership & sharing principle"]
              },
              {
                icon: "🚀",
                title: "Beta Launch",
                items: ["Launch MVP", "Communicate clear ethical standards", "Launch website & social media", "Start sustainability footprint DB (Innosuisse Grant)"],
                highlight: "June 2025"
              },
              {
                icon: "🤝",
                title: "Trust & Community Building",
                items: ["Personalise risk profiles through AI", "Establish personalised sustainability metrics", "Scale data-sharing network", "Design non-exclusive data fabric"]
              },
              {
                icon: "🌱",
                title: "Personalisation & Sustainability Leadership",
                items: ["Full personalised food recommendations", "Provide analytics for sustainability innovation", "Grow citizen-controlled data environment"]
              }
            ].map((phase, idx) => (
              <motion.div
                key={idx}
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex flex-col items-center gap-3 mb-4">
                      <h3 className="font-display text-2xl text-brand-deep text-center">{phase.title}</h3>
                      {phase.highlight && (
        ...
        <div className="text-center mt-8">
          <p className="text-sm text-brand-dark/50">← Scroll horizontally to see the full timeline →</p>
        </div>
      </Section>
      ...
      <Section className="items-center justify-center text-center py-20">
        ...
        >
          ...
          <p className="text-xl text-brand-dark/70 mb-12 leading-relaxed">
            This is just the beginning. We will improve. Help us build a value community where citizens increasingly regain control of their health and data to create sustainable livelihoods.
          </p>
          <div className="bg-white/95 backdrop-blur-lg p-10 md:p-14 rounded-3xl shadow-2xl border border-brand-leaf/20 mb-12">
            <p className="text-lg text-brand-dark/80 mb-8 leading-relaxed">
              With your support, we, as your proxy, will mature into a professional platform that truly reshapes how food connects to wellness—<strong>one mindful choice at a time</strong>.
            </p>
            <Button size="lg" className="bg-brand-deep text-white hover:bg-brand-dark rounded-full px-12 h-16 text-xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
              Download App
            </Button>
          </div>
        </motion.div>
      ...
      <Section className="justify-center items-center text-center py-20">
        <motion.div 
        ...
        >
          <div className="p-10 md:p-14 bg-gradient-to-b from-white to-brand-light">
            ...
            <p className="text-brand-dark/70 mb-8 text-lg">
              Be the first to experience the future of personalized nutrition. Get early access, exclusive insights, and community updates.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 mb-6">
              ...
              />
              <Button size="lg" className="h-14 px-8 bg-brand-deep hover:bg-brand-dark rounded-full">
                Join Now
              </Button>
            </div>
            <p className="text-xs text-brand-dark/40">
              We respect your privacy. Unsubscribe at any time. Your data stays yours.
            </p>
          </div>
        </motion.div>
